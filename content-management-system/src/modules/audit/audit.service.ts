...
import { createModuleLogger, logger } from "../../shared/utils/logger";
...
export class AuditService {
  ...
  constructor(
    @inject("CacheService") private readonly _cacheService: CacheService
  ) {}
  /**
   ...
   */
  async getSystemMetrics(_timeRange?: { start: Date; end: Date }): Promise<
    Result<
      {
        requests: number;
        errors: number;
