...
export class AuditController {
   ...
   */
  public getEntityAuditLogs = async (req: Request, res: Response, next: NextFunction) => {
    try {
      const { entityType, entityId } = req.params
      const { page, limit } = parsePaginationParams(req.query)

      const result = await auditService.getEntityAuditLogs(entityType, entityId, { page, limit })
   ...
   * Get user audit logs
   */
  public getUserAuditLogs = async (req: Request, res: Response, next: NextFunction) => {
    try {
   ...
   */
  public getRecentAuditLogs = async (req: Request, res: Response, next: NextFunction) => {
    try {
   ...
   */
  public deleteOldAuditLogs = async (req: Request, res: Response, next: NextFunction) => {
    try {
