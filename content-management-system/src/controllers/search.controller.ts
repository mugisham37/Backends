...
export class SearchController {
  ...
  public searchUsers = async (req: Request, res: Response, next: NextFunction) => {
    try {
      const { q, role, isActive, fields, page = 1, limit = 10, sort, order } = req.query as any
   ...
   * Search media
   */
  public searchMedia = async (req: Request, res: Response, next: NextFunction) => {
    try {
      const { q, type, mimeType, folder, tags, fields, page = 1, limit = 10, sort, order } = req.query as any
   ...
   * Reindex all content
   */
  public reindexContent = async (req: Request, res: Response, next: NextFunction) => {
    try {
   ...
   * Reindex all users
   */
  public reindexUsers = async (req: Request, res: Response, next: NextFunction) => {
    try {
   ...
   * Reindex all media
   */
  public reindexMedia = async (req: Request, res: Response, next: NextFunction) => {
    try {
