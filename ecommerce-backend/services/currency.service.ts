 ...
 */
export const createCurrency = async (currencyData: Partial<ICurrency>, requestId?: string): Promise<ICurrency> => {
  const logger = createRequestLogger(requestId)
 ...
 */
export const updateExchangeRates = async (apiKey: string, requestId?: string): Promise<ICurrency[]> => {
  const logger = createRequestLogger(requestId)
