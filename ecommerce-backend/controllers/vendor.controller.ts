 ...
 * @access Public
 */
export const getVendorBySlug = asyncHandler(
  async (req: Request, res: Response, next: NextFunction) => {
    const requestLogger = createRequestLogger(req.id);
...
export const getAllVendors = asyncHandler(async (req: Request, res: Response) => {
  ...
  const { vendors, count } = await vendorService.getAllVendors(
    filter,
...
export const getVendorProducts = asyncHandler(
  async (req: Request, res: Response, next: NextFunction) => {
    ...
    const { products, count } = await vendorService.getVendorProducts(
      id,
 ...
 * @access Protected (Admin, Vendor)
 */
export const getVendorMetrics = asyncHandler(
  async (req: Request, res: Response, next: NextFunction) => {
    const requestLogger = createRequestLogger(req.id);
    const { id } = req.params;
 ...
 * @access Protected (Admin, Vendor)
 */
export const getVendorPayouts = asyncHandler(
  async (req: Request, res: Response, next: NextFunction) => {
    const requestLogger = createRequestLogger(req.id);
    const { id } = req.params;
    ...
    const { payouts, count } = await vendorService.getVendorPayouts(
      id,
      { page, limit, sort, filter },
      req.id
    );
 ...
 * @access Protected (Admin)
 */
export const calculateVendorPayout = asyncHandler(
  async (req: Request, res: Response, next: NextFunction) => {
    const requestLogger = createRequestLogger(req.id);
    const { id } = req.params;
 ...
 * @access Protected (Admin)
 */
export const updatePayoutStatus = asyncHandler(
  async (req: Request, res: Response, next: NextFunction) => {
    const requestLogger = createRequestLogger(req.id);
    const { id } = req.params;
